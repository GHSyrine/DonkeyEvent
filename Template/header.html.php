...
<head>
    ...
    <link href="<?="http://".$_SERVER['HTTP_HOST'] . "/style.css"?>" rel="stylesheet">
    <title>Pathy</title>
</head>
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-lightp-3 bg-dark border-bottom">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <form class="d-flex" role="search" action="/movie/find" method="POST">
                            <input class="form-control m-1 me-1 p-1" name="search" type="text" placeholder="Recherche un film" aria-label="Search">
